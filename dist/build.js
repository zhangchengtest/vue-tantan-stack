...
var __vue_styles__ = {}
__webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"!!../../node_modules/extract-text-webpack-plugin/loader.js?{\"remove\":true}![object Object]!../../node_modules/vue-loader/lib/style-rewriter.js!../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./stack_basic.vue\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()))
__vue_script__ = __webpack_require__(5)
if (Object.keys(__vue_script__).some(function (key) { return key !== "default" && key !== "__esModule" })) {
  console.warn("[vue-loader] src/demo/stack_basic.vue: named exports in *.vue files are ignored.")}
...
var _detectPrefixes = __webpack_require__(13);
...
exports.default = {
  ...
  computed: {
    offsetRatio: function offsetRatio() {
      var width = this.$el.offsetWidth;
      var height = this.$el.offsetHeight;
      var offsetWidth = width - Math.abs(this.temporaryData.poswidth);
      var offsetHeight = height - Math.abs(this.temporaryData.posheight);
      var ratio = 1 - offsetWidth * offsetHeight / (width * height) || 0;
      return ratio > 1 ? 1 : ratio;
    },
    offsetWidthRatio: function offsetWidthRatio() {
      var width = this.$el.offsetWidth;
      var offsetWidth = width - Math.abs(this.temporaryData.poswidth);
      var ratio = 1 - offsetWidth / width || 0;
      return ratio;
    }
  },
  mounted: function mounted() {
  ...
  methods: {
    ...
    touchmove: function touchmove(e) {
      if (this.temporaryData.tracking && !this.temporaryData.animation) {
        ...
        var rotateDirection = this.rotateDirection();
        var angleRatio = this.angleRatio();
    ...
    touchend: function touchend(e) {
      ...
      if (this.offsetRatio >= 0.4) {
        var ratio = Math.abs(this.temporaryData.posheight / this.temporaryData.poswidth);
    ...
    nextTick: function nextTick() {
      ...
      this.$nextTick(function () {
        _this2.temporaryData.poswidth = 0;
        _this2.temporaryData.posheight = 0;
        _this2.temporaryData.opacity = 1;
        _this2.temporaryData.rotate = 0;
      });
    },
    onTransitionEnd: function onTransitionEnd(index) {
      var lastPage = this.temporaryData.currentPage === 0 ? this.pages.length - 1 : this.temporaryData.currentPage - 1;
    ...
    angleRatio: function angleRatio() {
      var height = this.$el.offsetHeight;
      var offsetY = this.temporaryData.offsetY;
      var ratio = -1 * (2 * offsetY / height - 1);
      return ratio || 0;
    },
    inStack: function inStack(index, currentPage) {
      var stack = [];
      var visible = this.temporaryData.visible;
    ...
    transform: function transform(index) {
      var currentPage = this.temporaryData.currentPage;
      var length = this.pages.length;
      var lastPage = currentPage === 0 ? this.pages.length - 1 : currentPage - 1;
      var style = {};
      var visible = this.temporaryData.visible;
      ...
      if (this.inStack(index, currentPage)) {
        var perIndex = index - currentPage > 0 ? index - currentPage : index - currentPage + length;
        style['opacity'] = '1';
    ...
    transformIndex: function transformIndex(index) {
      if (index === this.temporaryData.currentPage) {
        var style = {};
...
var __vue_script__, __vue_template__
var __vue_styles__ = {}
__webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"!!../../node_modules/extract-text-webpack-plugin/loader.js?{\"remove\":true}![object Object]!../../node_modules/vue-loader/lib/style-rewriter.js!../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./stack.vue\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()))
__vue_script__ = __webpack_require__(4)
if (Object.keys(__vue_script__).some(function (key) { return key !== "default" && key !== "__esModule" })) {
  console.warn("[vue-loader] src/components/stack.vue: named exports in *.vue files are ignored.")}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__demo_stack_basic__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__demo_stack_basic___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__demo_stack_basic__);
...
// 实例vue
new __WEBPACK_IMPORTED_MODULE_0_vue__["a" /* default */](__WEBPACK_IMPORTED_MODULE_2__demo_stack_basic___default.a)
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* WEBPACK VAR INJECTION */(function(global) {/* harmony export (immutable) */ __webpack_exports__["default"] = detectPrefixes;
/**
